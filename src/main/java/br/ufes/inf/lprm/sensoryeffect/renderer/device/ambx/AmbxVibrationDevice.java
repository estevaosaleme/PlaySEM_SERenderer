...
public class AmbxVibrationDevice extends SensoryEffectDeviceBase {
...
//		}	
		...
		byte p1 = (byte)0x91;
		byte device_type = 0x7B;
		byte p3 = 0x02;
		
		byte[] message = {p1, device_type, p3,(byte)((char)vibrationMessage.getIntensity().intValue()),(byte)((char)vibrationMessage.getIntensity().intValue())};
		return message;
	}
}
