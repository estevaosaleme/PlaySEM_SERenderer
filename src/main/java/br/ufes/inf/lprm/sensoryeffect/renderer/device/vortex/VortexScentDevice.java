package br.ufes.inf.lprm.sensoryeffect.renderer.device.vortex;
...
public class VortexScentDevice extends SensoryEffectDeviceBase {
	...
	public byte[] formatMessage(SensoryEffectMessage sensoryEffectMessage) {
		...
		byte[] message = {(byte)slotToActivate};
		return message;
	}
